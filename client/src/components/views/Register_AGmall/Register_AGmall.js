...
import {saveUserAgree} from '../../../_actions/user_action'
...
function Register_AGmall(props) {
    ...
    const agreeCheckedHandle1=()=>{
        setaccessCheckBox1(!accessCheckBox1)
    }
    const agreeCheckedHandle2=()=>{
        setaccessCheckBox2(!accessCheckBox2)
    }
    const AllAgreeHandle=()=>{
        if(accessCheckBox1 && accessCheckBox2){
            setaccessAllCheckBox(false)
            setaccessCheckBox1(false)
            setaccessCheckBox2(false)
        }else{
            setaccessAllCheckBox(true)
            setaccessCheckBox1(true)
            setaccessCheckBox2(true)
        }
    }
    const identifyCheck=()=>{
    ...
    const variables={
        agreeUsage: accessCheckBox1,
        agreePersonal : accessCheckBox2
    }
    const agreeCheck=(e)=>{
        if(!accessCheckBox1 || !accessCheckBox2){
    ...
    return (
        <div>
            <Header/>
            <div className="register_ag_1step_wrap">
                <div className="top">
                    <h1>회원가입</h1>
                    <ol>
                        <li>01 약관동의</li>
                ...
                <form>
                    <fieldset className="access">
                        ...
                        <ul>
                            <li>
                                <input id="accessAll" type="checkbox" value="agreeTerms" name="agreeAll" checked={accessAllCheckBox} onChange={AllAgreeHandle}/>
                                <label htmlFor="accessAll">
                                    <span><strong>안국건강의 모든 약관을 확인하고 전체 동의합니다.</strong> (전체동의, 선택항목도 포함됩니다.)</span>
                                </label>
                            </li>
                            <li>
                                <input id="accessUsage" required type="checkbox" value="agreeTerms" name="agreeUsage"
                                    checked={accessCheckBox1} onChange={agreeCheckedHandle1}
                                />
                                <label htmlFor="accessUsage">
                                    <span><strong>(필수) </strong>이용약관 </span>
                                    <a href="/usageterms" target="_blank" title="이용약관 전체 새창열기">전체보기</a>
                                </label>
                                <div>
                                    제1조(목적)
                                    <br/><br/>
                                    표준약관 제10023호
                                    <br/><br/>
                                    이 약관은 안국건강 회사(전자거래 사업자)가 운영하는 안국건강 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
                                    ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
                                    <br/>
                                    <br/><br/>
                                    제2조(정의)
                                    <br/><br/>
                                    ① "몰"이란 안국건강 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/>
                                    ...
                                    다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 14일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 "몰“은 개정전 내용과 개정후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.<br/>
                                    ...
                                    <br/>④ "몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보 보호책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
                                    ...
                                    <br/>부칙
                                    <br/>
                                    <br/>1. 이 약관은 2018년 05월 03일부터 적용됩니다.
                                </div>
                            </li>
                            <li>
                                <input id="accessPersonal" required type="checkbox" value="agreeTerms" name="agreePersonal"
                                    checked={accessCheckBox2} onChange={agreeCheckedHandle2}
                                />
                                <label htmlFor="accessPersonal">
                                    <span><strong>(필수) </strong>개인정보 수집 및 이용 </span>
                                    <a href="/personalterms" target="_blank" title="개인정보 수집 및 이용약관 전체 새창열기">전체보기</a>
                                </label>
                                <div>
                    ...
                    <fieldset className="identify">
                        <h2>본인 인증방법 선택</h2>
                        <div>
                            <input required id="identiPersonal" type="radio" value="identify" name="identifyPhone"
                                checked={identify} onChange={identifyCheck}
                            />
                            <label htmlFor="identiPersonal"><span>휴대폰 본인인증</span></label>
                        </div>
                    </fieldset>
                </form>
                <div className="stepBtn">
                    <a href="/register" target="_self" title="">이전단계</a>
                    <form onSubmit={agreeCheck}>
...
export default withRouter(Register_AGmall)

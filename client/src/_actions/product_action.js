...
export function ImportProd(dataToSubmit){
    const request=axios.post('https://agmall.herokuapp.com/api/product/prodDetail', dataToSubmit, config)
...
export function SaveRecentViewProd(dataToSubmit){
    const request=axios.post('https://agmall.herokuapp.com/api/product/saveRecentView', dataToSubmit, config)
        .then(response=>response.data)
    return{
...
export function ImportRecentViewProd(dataToSubmit){
    const request=axios.post('https://agmall.herokuapp.com/api/product/importRecentView', dataToSubmit, config)
        .then(response=>response.data)
    return{
